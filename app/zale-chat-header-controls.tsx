...
export default function ZaleChatHeaderControls(){
  ...
  useEffect(()=>{
    ...
    style.textContent=`
      .zale-header-tools{margin-left:auto;display:flex;gap:7px;align-items:center;position:relative;z-index:100}
      .zale-header-tools button{width:38px;height:38px;min-height:38px;border:1px solid #e1daf2;border-radius:999px;background:#fff;color:#4f2aaf;font-weight:900;display:grid;place-items:center;touch-action:manipulation;cursor:pointer}
      .zale-header-tools button:hover{background:#f3efff}
      ...
      @media(max-width:760px){.zale-header-tools{gap:4px}.zale-header-tools button{width:35px;height:35px;min-height:35px}.zale-header-menu{right:10px;top:64px}}
    `;
