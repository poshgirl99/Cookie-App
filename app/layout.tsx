...
import CookieStoryToolAutoclose from "./cookie-story-tool-autoclose";
import CookieStoryAutoTextSize from "./cookie-story-auto-text-size";
...
import CookieFriendAcceptSafety from "./cookie-friend-accept-safety";
  ...
  return (
    <html lang="en">
      <body>
        ...
        <CookieHideAaText />
        <CookieStoryToolAutoclose />
        <CookieStoryAutoTextSize />
        <CookieStoryLiveToastTimeout />
        <CookieStoryViewers />
        <CookieBestFriendsRefresh />
        <CookieUxHardening />
        <CookieFriendAcceptSafety />
        <ZalePresenceStatus />
        <ZeeAI />
        <ZeeChatList />
        <ChatCorePolish />
